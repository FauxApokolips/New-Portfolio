...
export default function App() {
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden">
      ...
      {/* LEVEL-11 MULTI-LAYER GPU SHADER BACKGROUND */}
      {/* Layer 1: Cosmic Nebula Shader */}
      <ShaderBackground />
      <ParallaxGlow speed={0.10} color="rgba(0,255,255,0.25)" />

      {/* Layer 2: Glow Parallax (CSS + R3F hybrid) */}
      <GlowParallax strength={0.12} />

      {/* Layer 3: Soft noise + ambient */}
      <GlassNoise />
      <AmbientLight blur={120} />

      {/* Layer 4: Depth parallax particles */}
